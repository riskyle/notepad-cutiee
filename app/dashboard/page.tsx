...
export default function DashboardScreen() {
  return (
    <div className="min-h-screen bg-[#EFECE1] flex justify-center font-sans text-[#1A1A1A]">
      ...
      <main className="w-full max-w-md relative pb-32 px-5 pt-12 overflow-y-auto">
        ...
        <div className="fixed bottom-8 w-full max-w-md px-5 left-1/2 -translate-x-1/2 z-50 flex justify-between gap-3">
          <button className="flex-1 bg-white shadow-[0_8px_30px_rgba(0,0,0,0.12)] rounded-full py-4 px-6 flex items-center justify-center border border-black/5">
          ...
          <button className="bg-[#CC6B36] shadow-[0_8px_30px_rgba(204,107,54,0.3)] rounded-full py-4 px-8 flex items-center justify-center gap-1.5 transition-transform active:scale-95">
