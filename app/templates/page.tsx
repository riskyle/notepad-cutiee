...
export default function TemplatesScreen() {
  return (
    <div className="min-h-screen bg-[#EFECE1] flex justify-center font-sans text-[#1A1A1A]">
      <main className="w-full max-w-md relative pb-12 px-5 pt-12 overflow-y-auto">
        ...
        <header className="flex items-center gap-4 mb-6">
          ...
          <Link
            href="/dashboard"
            className="w-10 h-10 rounded-full bg-[#E4DFD2] flex items-center justify-center text-[#1A1A1A] transition-transform active:scale-95"
          >
          ...
          <div>
            <h1 className="font-fraunces text-3xl leading-none font-black tracking-tight mb-1">
              Templates
            </h1>
        ...
        <div className="flex gap-2 overflow-x-auto pb-6 hide-scrollbar">
          <button className="shrink-0 px-5 py-2 rounded-full bg-[#1A1A1A] text-white text-sm font-bold">
            All
          </button>
          <button className="shrink-0 px-5 py-2 rounded-full bg-transparent border border-[#D5D0C4] text-[#5C5852] text-sm font-bold">
            Productivity
          </button>
          <button className="shrink-0 px-5 py-2 rounded-full bg-transparent border border-[#D5D0C4] text-[#5C5852] text-sm font-bold">
            Journal
